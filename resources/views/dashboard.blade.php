...
<div class="mx-auto max-w-5xl px-4 py-10 sm:px-6">
    <div class="mb-8">
        ...
        <p class="mt-2 text-sm text-slate-500">Your account overview.</p>
    </div>

    <div id="dashboard-loading" class="rounded-2xl border border-slate-200 bg-white p-8 shadow-sm">
        <div class="flex items-center gap-3 text-slate-500">
            <svg class="h-5 w-5 animate-spin text-teal-700" viewBox="0 0 24 24" fill="none" aria-hidden="true">
    ...
    <div id="dashboard-content" class="hidden">
        <div class="grid gap-4 sm:grid-cols-3">
            ...
            <div class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
                ...
                <p id="user-role" class="mt-2 text-lg font-semibold capitalize text-teal-700">—</p>
            </div>
        </div>
    </div>
</div>
